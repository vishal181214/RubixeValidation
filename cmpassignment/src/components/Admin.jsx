...
function Admin() {
    ...
    const fetchData = async () => {
        await axios.get("https://validator-project-api.onrender.com/home/reserve").then((res) => {
            setData(res.data);
        })
            .catch((err) => {
    ...
    const deleteRecord = async (id) => {
        ...
        try {
            const res = await axios.post(`https://validator-project-api.onrender.com/home/users/delete/${id}`);
            if (res) {
    ...
    const updateUser = async () => {
        ...
        try {
            const res = await axios.put(`https://validator-project-api.onrender.com/home/users/update/${userId}`, {
                name,
                cellnum,
                email
            });
